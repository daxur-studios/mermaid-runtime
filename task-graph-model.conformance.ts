 ...
 */
export type DaemonSatisfiesMermaidRuntime = [
  AssertExtends<DaxurDaemonAPI.TaskRunNode, MermaidRuntime.Node>,
  AssertExtends<DaxurDaemonAPI.TaskRunNodeStatus, MermaidRuntime.NodeStatus>,
  AssertExtends<DaxurDaemonAPI.TaskRunTransition, MermaidRuntime.Transition>,
  AssertExtends<DaxurDaemonAPI.TaskRunInspectableRef, MermaidRuntime.InspectableRef>,
  AssertExtends<DaxurDaemonAPI.TaskRunInspectableRefKind, MermaidRuntime.InspectableRefKind>,
  AssertExtends<DaxurDaemonAPI.TaskRunRefContent, MermaidRuntime.RefContent>,
];
